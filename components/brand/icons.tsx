...
function Icon({ children, className }: IconProps & { readonly children: React.ReactNode }) {
  return (
    <svg
      viewBox="0 0 24 24"
      width="24"
...
function StrokeIcon({ children, className }: IconProps & { readonly children: React.ReactNode }) {
  return (
    <svg
      viewBox="0 0 24 24"
      width="20"
